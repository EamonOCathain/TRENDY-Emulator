...
python -u global_r2.py \
  --job_name base_model/no_carry/test/ \
  --preds_dir /Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/data/predictions/base_model_new_loss/no_carry/zarr \
