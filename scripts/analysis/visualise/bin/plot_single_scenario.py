...
def main():
    ...
    ap.add_argument("--preds_dir", default="/Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/data/predictions/nudge_array_check", type=Path)
    ...
    arrays = [f"nudge_{i/100:.2f}" for i in range(11)]
    ...
    # Plots out dir
    if not args.out_dir:
            out_dir = Path("/Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/scripts/analysis/visualise/plots") / Path(args.preds_dir).stem
    else:
