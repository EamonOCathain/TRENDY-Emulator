...
def main(in_path: str,
    ...
    # --- Step 1: keep only {time, lat, lon, lai} and rename to lai_avh15c1 ---
    ...
    with xr.open_dataset(out_path, engine="netcdf4", decode_times=False, chunks={}) as ds:
        ...
        v = ds["lai_avh15c1"]
        print("lai_avh15c1 chunksizes:", v.encoding.get("chunksizes"))

if __name__ == "__main__":
    # Example usage:
    # python convert_avh15c1_to_1901_noleap.py \
    #   /path/to/AVH15C1/lai.nc \
    #   /path/to/output/lai_avh15c1_1901_noleap_r720x360.nc
    if len(sys.argv) < 3:
