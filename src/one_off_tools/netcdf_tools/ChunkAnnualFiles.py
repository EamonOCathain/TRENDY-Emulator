...
HIST_SRC = PROJECT_ROOT / "data/preprocessed/model_outputs"
HIST_DST = PROJECT_ROOT / "data/preprocessed/1x1/model_outputs"
PI_SRC   = PROJECT_ROOT / "data/preprocessed/preindustrial/full_time"
PI_DST   = PROJECT_ROOT / "data/preprocessed/1x1/preindustrial/full_time"

# nccopy settings
CLEVEL     = 4     # deflate level
LAT_CHUNK  = 1
LON_CHUNK  = 1
OVERWRITE  = False  # set False to skip existing outputs
