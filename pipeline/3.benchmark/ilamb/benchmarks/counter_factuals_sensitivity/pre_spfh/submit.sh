...
# Paths
cd /Net/Groups/BGI/work_2/TRENDY-Emulator-Data/benchmarks/benchmarks/counter_factuals_sensitivity/pre_spfh
export ILAMB_ROOT="/Net/Groups/BGI/work_2/TRENDY-Emulator-Data/benchmarks/benchmarks/counter_factuals_sensitivity/pre_spfh"
