...
# Paths
cd /Net/Groups/BGI/work_2/TRENDY-Emulator-Data/benchmarks/benchmarks/counter_factuals_sensitivity/CO2
export ILAMB_ROOT="/Net/Groups/BGI/work_2/TRENDY-Emulator-Data/benchmarks/benchmarks/counter_factuals_sensitivity/CO2"
