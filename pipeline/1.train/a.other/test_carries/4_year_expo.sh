...
torchrun --standalone --nnodes=1 --nproc_per_node=${NPROC} /Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/pipeline/1.train/train.py \
  ...
  --use_foundation /Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/checkpoints/carry/exponential/4_year/checkpoints/best.pt \
  --test_only \
  --diagnostics_only 
