...
torchrun --standalone --nnodes=1 --nproc_per_node=${NPROC} train.py \
  --job_name test_sequential_months \
  --epochs 40 \
  --num_workers 4 \
  --val_frac 0.5 \
  --test_frac 0.1 \
  ...
  --use_foundation /Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/checkpoints/carry/sequential_months/checkpoints/best.pt \
  --test_only \
  --diagnostics_only 
