...
: "${ILAMB_DIR_GLOBAL:=/Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/pipeline/3.benchmark/ilamb/benchmarks/counter_factuals_sensitivity/MODELS}"
: "${NUMBER_TILES:=16}"
...
: "${OUT_DIR:=/Net/Groups/BGI/people/ecathain/TRENDY_Emulator_Scripts/NewModel/data/predictions/counter_factuals_sensitivity}"

# Periods
: "${STORE_PERIOD:=1901-01-01:1930-12-31}"
: "${WRITE_PERIOD:=1901-01-01:1930-12-31}"
